        ...
        var infoWindow = new google.maps.InfoWindow;
          downloadUrl('https://storage.googleapis.com/mapsdevsite/json/mapmarkers2.xml', function(data) {
            ...
            Array.prototype.forEach.call(markers, function(markerElem) {
              ...
              var name = markerElem.getAttribute('Casa Elyson');
              var address = markerElem.getAttribute('Rua Joaquim Branco');
              var type = markerElem.getAttribute('roadmap');
              var point = new google.maps.LatLng(
                  parseFloat(markerElem.getAttribute('-8.8864573')),
                  parseFloat(markerElem.getAttribute('-36.4976255')));
