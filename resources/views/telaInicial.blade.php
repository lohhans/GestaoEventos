...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        ...
        </br><h1 class="text-center"> BEM-VINDO AO NOSSO SITE! </h1></br>

        <img src="https://media.makeameme.org/created/amei-foda-topper.jpg" class="rounded mx-auto d-block" alt="Responsive image">
