...
<html lang="en">
    ...
    <body>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container">
                <img class="img-fluid mb-5 d-block mx-auto" src="images/logoRedondo.png" alt="" style="width:300; height:300px;">
                <h1 class="text-uppercase mb-0">Gestão de Eventos</h1>
                <hr class="star-light">
                <h2 class="font-weight-light mb-0">Visite os eventos que cercam a nossa faculdade!</h2>
            </div>
        </header>
        ...
        <section class="portfolio" id="portfolio">
            <div class="container">
                <h2 class="text-center text-uppercase text-secondary mb-0">Nossos Eventos</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto">
                        <p class="lead">Site em desenvolvimento. Realizado pelos alunos Antônio Adelino, Armstrong Lohãns, Elyson Romeiro e Gabrielle Amorim, para a disciplina de Desenvolvimento Web, na Universidade Federal Rural de Pernambuco - Unidade Acadêmica Garanhuns.</p>
                    </div>
                    <div class="col-lg-4 mr-auto">
                        <p class="lead">Temos como objetivo criar um site em que seja possível cadastrar, visualizar e se inscrever em eventos, estes realizados na Faculdade local, fiquem ligados no projeto!</p>
                    </div>
                </div>
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light" href="https://github.com/elysonromeiro/GestaoEventos">
